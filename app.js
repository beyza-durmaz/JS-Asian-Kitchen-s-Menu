...
let categoryList = [...new Set(menu.map(element => element.category))];
categoryList.unshift("All");

categoryList.map(category => btnContainer.append(createButton(category)));

// menu-items
function createItems(item){
  let items = `
  <div class = "menu-items col-lg-6 col-sm-12">
  <img src = ${item.img} alt = ${item.title} class = "photo img-fluid img-thumbnail d-block w-100">
  <div class = "menu-info">
